...
# install a tgz file of pictures to our pictures directory if it isn't already there
test -f ~/Pictures/pics.tgz || wget -q -O ~/Pictures/pics.tgz https://zonzorp.net/pics.tgz tarfile
...
# delete the downloded tgz file using tar 
